...
function HEX5BHEX5D_738198811(s_738198814, x_738198815) {
  var result_738198816 = [];
    ...
    Label1: {
      ...
      Label2: {
          Label3: while (true) {
          if (!(i_570426502 < L_738198820)) break Label3;
            i_738198825 = i_570426502;
...
async function loadIndex_570426194() {
  ...
  BeforeRet: {
    ...
    var rootURL_570426228 = HEX5BHEX5D_738198811(cstrToNimstr(indexURL_570426202), HEX2EHEX2E_973078628(0, 14));
