/* Generated by the Nim Compiler v1.4.9 */
var framePtr = null;
var excHandler = 0;
var lastJSError = null;
var NTI10421058 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NTI1194653 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
var NTI10580580 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
...
NTI10580580.base = NTI1188015;
var NNI1194653 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI1194653.node = NNI1194653;
NTI1194653.base = NTI1194619;
var NNI10421058 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI1188044, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI1188064, name: "Field1", sons: null}]};
NTI10421058.node = NNI10421058;
...
function isWhitespace_10555116(text_10555118) {
         return !/[^\s]/.test(text_10555118);
  

  
}
function isWhitespace_10555133(x_10555135) {
    var Tmp1;
    var Tmp2;

  var result_10555136 = false;

    if (!(x_10555135.nodeName == "#text")) Tmp2 = false; else {      Tmp2 = isWhitespace_10555116(x_10555135.textContent);    }    if (Tmp2) Tmp1 = true; else {      Tmp1 = (x_10555135.nodeName == "#comment");    }    result_10555136 = Tmp1;

  return result_10555136;
...
function toToc_10555150(x_10555152, father_10555153) {
                var Tmp5;
            var Tmp6;
            var Tmp7;
            var Tmp8;
    ...
    if ((x_10555152.nodeName == "UL")) {
    var f_10555174 = {heading: null, kids: [], sortId: (father_10555153.kids).length, doSort: false};
    var i_10555176 = 0;
    L1: do {
        L2: while (true) {
        if (!(i_10555176 < x_10555152.childNodes.length)) break L2;
          var nxt_10555177 = addInt(i_10555176, 1);
          L3: do {
              L4: while (true) {
                if (!(nxt_10555177 < x_10555152.childNodes.length)) Tmp5 = false; else {                  Tmp5 = isWhitespace_10555133(x_10555152.childNodes[nxt_10555177]);                }              if (!Tmp5) break L4;
                nxt_10555177 = addInt(nxt_10555177, 1);
              }
          } while(false);
            if (!(nxt_10555177 < x_10555152.childNodes.length)) Tmp8 = false; else {              Tmp8 = (x_10555152.childNodes[i_10555176].nodeName == "LI");            }            if (!Tmp8) Tmp7 = false; else {              Tmp7 = (x_10555152.childNodes[i_10555176].childNodes.length == 1);            }            if (!Tmp7) Tmp6 = false; else {              Tmp6 = (x_10555152.childNodes[nxt_10555177].nodeName == "UL");            }          if (Tmp6) {
          var e_10555204 = {heading: x_10555152.childNodes[i_10555176].childNodes[0], kids: [], sortId: (f_10555174.kids).length, doSort: false};
          var it_10555205 = x_10555152.childNodes[nxt_10555177];
          L9: do {
            var j_10555213 = 0;
            var colontmp__10580445 = 0;
            colontmp__10580445 = it_10555205.childNodes.length;
            var i_10580446 = 0;
            L10: do {
                L11: while (true) {
                if (!(i_10580446 < colontmp__10580445)) break L11;
                  j_10555213 = i_10580446;
                  toToc_10555150(it_10555205.childNodes[j_10555213], e_10555204);
                  i_10580446 = addInt(i_10580446, 1);
                }
            } while(false);
          } while(false);
          f_10555174.kids.push(e_10555204);;
          i_10555176 = addInt(nxt_10555177, 1);
          }
          else {
            toToc_10555150(x_10555152.childNodes[i_10555176], f_10555174);
            i_10555176 = addInt(i_10555176, 1);
          }
          
        }
    } while(false);
    father_10555153.kids.push(f_10555174);;
    }
    else {
    if (isWhitespace_10555133(x_10555152)) {
    }
    else {
    if ((x_10555152.nodeName == "LI")) {
    var idx_10555252 = [];
    L12: do {
      var i_10555260 = 0;
      var colontmp__10580449 = 0;
      colontmp__10580449 = x_10555152.childNodes.length;
      var i_10580450 = 0;
      L13: do {
          L14: while (true) {
          if (!(i_10580450 < colontmp__10580449)) break L14;
            i_10555260 = i_10580450;
            if (!(isWhitespace_10555133(x_10555152.childNodes[i_10555260]))) {
            idx_10555252.push(i_10555260);;
            }
            
            i_10580450 = addInt(i_10580450, 1);
          }
      } while(false);
    } while(false);
      if (!((idx_10555252).length == 2)) Tmp15 = false; else {        Tmp15 = (x_10555152.childNodes[idx_10555252[chckIndx(1, 0, (idx_10555252).length-1)]].nodeName == "UL");      }    if (Tmp15) {
    var e_10555294 = {heading: x_10555152.childNodes[idx_10555252[chckIndx(0, 0, (idx_10555252).length-1)]], kids: [], sortId: (father_10555153.kids).length, doSort: false};
    var it_10555295 = x_10555152.childNodes[idx_10555252[chckIndx(1, 0, (idx_10555252).length-1)]];
    L16: do {
      var j_10555303 = 0;
      var colontmp__10580454 = 0;
      colontmp__10580454 = it_10555295.childNodes.length;
      var i_10580455 = 0;
      L17: do {
          L18: while (true) {
          if (!(i_10580455 < colontmp__10580454)) break L18;
            j_10555303 = i_10580455;
            toToc_10555150(it_10555295.childNodes[j_10555303], e_10555294);
            i_10580455 = addInt(i_10580455, 1);
          }
      } while(false);
    } while(false);
    father_10555153.kids.push(e_10555294);;
    }
    else {
      L19: do {
        var i_10555319 = 0;
        var colontmp__10580458 = 0;
        colontmp__10580458 = x_10555152.childNodes.length;
        var i_10580459 = 0;
        L20: do {
            L21: while (true) {
            if (!(i_10580459 < colontmp__10580458)) break L21;
              i_10555319 = i_10580459;
              toToc_10555150(x_10555152.childNodes[i_10555319], father_10555153);
              i_10580459 = addInt(i_10580459, 1);
            }
        } while(false);
      } while(false);
    }
    ...
    father_10555153.kids.push({heading: x_10555152, kids: [], sortId: (father_10555153.kids).length, doSort: false});;
    }
    }}

  
}
function extractItems_10510075(x_10510077, heading_10510078, items_10510081, items_10510081_Idx) {
      var Tmp1;
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      if (!!((x_10510077.heading == null))) Tmp1 = false; else {        Tmp1 = (x_10510077.heading.textContent == heading_10510078);      }    if (Tmp1) {
    L2: do {
      var i_10515021 = 0;
      var colontmp__10580475 = 0;
      colontmp__10580475 = (x_10510077.kids).length;
      var i_10580476 = 0;
      L3: do {
          L4: while (true) {
          if (!(i_10580476 < colontmp__10580475)) break L4;
            i_10515021 = i_10580476;
            items_10510081[items_10510081_Idx].push(x_10510077.kids[chckIndx(i_10515021, 0, (x_10510077.kids).length-1)].heading);;
            i_10580476 = addInt(i_10580476, 1);
          }
      } while(false);
    } while(false);
    }
      ...
      L5: do {
        var i_10515042 = 0;
        var colontmp__10580479 = 0;
        colontmp__10580479 = (x_10510077.kids).length;
        var i_10580480 = 0;
        L6: do {
            L7: while (true) {
            if (!(i_10580480 < colontmp__10580479)) break L7;
              i_10515042 = i_10580480;
              var it_10515043 = x_10510077.kids[chckIndx(i_10515042, 0, (x_10510077.kids).length-1)];
              extractItems_10510075(it_10515043, heading_10510078, items_10510081, items_10510081_Idx);
              i_10580480 = addInt(i_10580480, 1);
            }
        } while(false);
      } while(false);
    }
...
function tree_10501020(tag_10501022, kids_10501024) {
  var result_10501025 = null;

    result_10501025 = document.createElement(toJSStr(tag_10501022));
    L1: do {
      var k_10501058 = null;
      var k_10501058_Idx = 0;
      var i_10580496 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_10580496 < (kids_10501024).length)) break L3;
            k_10501058 = kids_10501024; k_10501058_Idx = chckIndx(i_10580496, 0, (kids_10501024).length-1);
            result_10501025.appendChild(k_10501058[k_10501058_Idx]);
            i_10580496 = addInt(i_10580496, 1);
          }
      } while(false);
    } while(false);

  return result_10501025;

}
function text_10501169(s_10501171) {
  var result_10501172 = null;

    result_10501172 = document.createTextNode(s_10501171);

  return result_10501172;
...
function uncovered_10560022(x_10560024) {
      var Tmp1;
    var Tmp2;

  var result_10560025 = null;

  BeforeRet: do {
      if (!((x_10560024.kids).length == 0)) Tmp1 = false; else {        Tmp1 = !((x_10560024.heading == null));      }    if (Tmp1) {
    if (!(x_10560024.heading.hasOwnProperty('__karaxMarker__'))) {
    Tmp2 = x_10560024;
    }
    else {
    Tmp2 = null;
    ...
    result_10560025 = Tmp2;
    break BeforeRet;
    }
    
    result_10560025 = {heading: x_10560024.heading, kids: [], sortId: x_10560024.sortId, doSort: x_10560024.doSort};
    L3: do {
      var i_10565036 = 0;
      var colontmp__10580507 = 0;
      colontmp__10580507 = (x_10560024.kids).length;
      var i_10580508 = 0;
      L4: do {
          L5: while (true) {
          if (!(i_10580508 < colontmp__10580507)) break L5;
            i_10565036 = i_10580508;
            var y_10565037 = uncovered_10560022(x_10560024.kids[chckIndx(i_10565036, 0, (x_10560024.kids).length-1)]);
            if (!((y_10565037 == null))) {
            result_10560025.kids.push(y_10565037);;
            }
            
            i_10580508 = addInt(i_10580508, 1);
          }
      } while(false);
    } while(false);
    if (((result_10560025.kids).length == 0)) {
    result_10560025 = null;
    }
    
  } while (false);

  return result_10560025;

}
function mergeTocs_10570035(orig_10570037, news_10570038) {
  var result_10570039 = null;

    result_10570039 = uncovered_10560022(orig_10570037);
    if ((result_10570039 == null)) {
    result_10570039 = news_10570038;
    }
    else {
      L1: do {
        var i_10570060 = 0;
        var colontmp__10580502 = 0;
        colontmp__10580502 = (news_10570038.kids).length;
        var i_10580503 = 0;
        L2: do {
            L3: while (true) {
            if (!(i_10580503 < colontmp__10580502)) break L3;
              i_10570060 = i_10580503;
              result_10570039.kids.push(news_10570038.kids[chckIndx(i_10570060, 0, (news_10570038.kids).length-1)]);;
              i_10580503 = addInt(i_10580503, 1);
            }
        } while(false);
      } while(false);
    }
...
function buildToc_10570082(orig_10570084, types_10570086, procs_10570087) {
                      var Tmp7;

  var result_10570088 = null;

    var newStuff_10570104 = {heading: null, kids: [], doSort: true, sortId: 0};
    L1: do {
      var t_10580214 = null;
      var t_10580214_Idx = 0;
      var i_10580491 = 0;
      var L_10580492 = (types_10570086).length;
      L2: do {
          L3: while (true) {
          if (!(i_10580491 < L_10580492)) break L3;
            t_10580214 = types_10570086; t_10580214_Idx = chckIndx(i_10580491, 0, (types_10570086).length-1);
            var c_10580230 = {heading: t_10580214[t_10580214_Idx].cloneNode(true), kids: [], doSort: true, sortId: 0};
            t_10580214[t_10580214_Idx].__karaxMarker__ = true;
            L4: do {
              var p_10580238 = null;
              var p_10580238_Idx = 0;
              var i_10580488 = 0;
              var L_10580489 = (procs_10570087).length;
              L5: do {
                  L6: while (true) {
                  if (!(i_10580488 < L_10580489)) break L6;
                    p_10580238 = procs_10570087; p_10580238_Idx = chckIndx(i_10580488, 0, (procs_10570087).length-1);
                    if (!(p_10580238[p_10580238_Idx].hasOwnProperty('__karaxMarker__'))) {
                    var xx_10580239 = p_10580238[p_10580238_Idx].parentNode.getElementsByClassName("attachedType");
                      if (!((xx_10580239).length == 1)) Tmp7 = false; else {                        Tmp7 = (xx_10580239[chckIndx(0, 0, (xx_10580239).length-1)].textContent == t_10580214[t_10580214_Idx].textContent);                      }                    if (Tmp7) {
                    var q_10580247 = tree_10501020(makeNimstrLit("A"), [text_10501169(p_10580238[p_10580238_Idx].title)]);
                    q_10580247.setAttribute("href", p_10580238[p_10580238_Idx].getAttribute("href"));
                    c_10580230.kids.push({heading: q_10580247, kids: [], sortId: 0, doSort: false});;
                    p_10580238[p_10580238_Idx].__karaxMarker__ = true;
                    }
                    
                    }
                    
                    i_10580488 = addInt(i_10580488, 1);
                    if (!(((procs_10570087).length == L_10580489))) {
            ...
            newStuff_10570104.kids.push(c_10580230);;
            i_10580491 = addInt(i_10580491, 1);
            if (!(((types_10570086).length == L_10580492))) {
            failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    result_10570088 = mergeTocs_10570035(orig_10570084, newStuff_10570104);

  return result_10570088;

}
function add_10501117(parent_10501119, kid_10501120) {
      var Tmp1;
        var Tmp2;

      if (!(parent_10501119.nodeName == "TR")) Tmp1 = false; else {        if ((kid_10501120.nodeName == "TD")) Tmp2 = true; else {          Tmp2 = (kid_10501120.nodeName == "TH");        }        Tmp1 = Tmp2;      }    if (Tmp1) {
    var k_10501121 = document.createElement("TD");
    k_10501121.appendChild(kid_10501120);
    parent_10501119.appendChild(k_10501121);
    }
    else {
    parent_10501119.appendChild(kid_10501120);
    }
    

  
}
function setClass_10501135(e_10501137, value_10501138) {
    e_10501137.setAttribute("class", toJSStr(value_10501138));

  
}
function toHtml_10515072(x_10515074, isRoot_10515075) {
      var Tmp1;
    function HEX3Aanonymous_10520015(a_10520017, b_10520018) {
          var Tmp1;

      var result_10520019 = 0;

      BeforeRet: do {
          if (!!((a_10520017.heading == null))) Tmp1 = false; else {            Tmp1 = !((b_10520018.heading == null));          }        if (Tmp1) {
        var x_10530009 = a_10520017.heading.textContent;
        var y_10530010 = b_10520018.heading.textContent;
        if ((x_10530009 < y_10530010)) {
        result_10520019 = -1;
        break BeforeRet;
        }
        
        if ((y_10530010 < x_10530009)) {
        result_10520019 = 1;
        break BeforeRet;
        }
        ...
        break BeforeRet;
          ...
          result_10520019 = subInt(a_10520017.sortId, b_10520018.sortId);
          break BeforeRet;
        }
        
      } while (false);

      return result_10520019;

    }

  var result_10515076 = null;

  BeforeRet: do {
    if ((x_10515074 == null)) {
    result_10515076 = null;
    break BeforeRet;
    }
    
    if (((x_10515074.kids).length == 0)) {
    if ((x_10515074.heading == null)) {
    result_10515076 = null;
    break BeforeRet;
    }
    
    result_10515076 = x_10515074.heading.cloneNode(true);
    break BeforeRet;
    }
    
    result_10515076 = tree_10501020(makeNimstrLit("DIV"), []);
      if (!!((x_10515074.heading == null))) Tmp1 = false; else {        Tmp1 = !(x_10515074.heading.hasOwnProperty('__karaxMarker__'));      }    if (Tmp1) {
    add_10501117(result_10515076, x_10515074.heading.cloneNode(true));
    }
    
    var ul_10520012 = tree_10501020(makeNimstrLit("UL"), []);
    if (isRoot_10515075) {
    setClass_10501135(ul_10520012, makeNimstrLit("simple simple-toc"));
    }
    else {
    setClass_10501135(ul_10520012, makeNimstrLit("simple"));
    }
    
    if (x_10515074.doSort) {
    x_10515074.kids.sort(HEX3Aanonymous_10520015);
    }
    
    L2: do {
      var k_10545214 = null;
      var k_10545214_Idx = 0;
      var i_10580514 = 0;
      var L_10580515 = (x_10515074.kids).length;
      L3: do {
          L4: while (true) {
          if (!(i_10580514 < L_10580515)) break L4;
            k_10545214 = x_10515074.kids; k_10545214_Idx = chckIndx(i_10580514, 0, (x_10515074.kids).length-1);
            var y_10545215 = toHtml_10515072(k_10545214[k_10545214_Idx], false);
            if (!((y_10545215 == null))) {
            add_10501117(ul_10520012, tree_10501020(makeNimstrLit("LI"), [y_10545215]));
            }
            
            i_10580514 = addInt(i_10580514, 1);
            if (!(((x_10515074.kids).length == L_10580515))) {
            failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    if (!((ul_10520012.childNodes.length == 0))) {
    add_10501117(result_10515076, ul_10520012);
    }
    
    if ((result_10515076.childNodes.length == 0)) {
    result_10515076 = null;
    }
    
  } while (false);

  return result_10515076;

}
function replaceById_10501189(id_10501191, newTree_10501192) {
    var x_10501193 = document.getElementById(id_10501191);
    x_10501193.parentNode.replaceChild(newTree_10501192, x_10501193);
    newTree_10501192.id = id_10501191;

  
}
function togglevis_10580336(d_10580338) {
        if (d_10580338.style.display == 'none')
      d_10580338.style.display = 'inline';
    else
      d_10580338.style.display = 'none';
  

  
}
function groupBy(value_10580354) {
    var toc_10580355 = document.getElementById("toc-list");
    if ((alternative_10580322[0] == null)) {
    var tt_10580376 = {heading: null, kids: [], sortId: 0, doSort: false};
    toToc_10555150(toc_10580355, tt_10580376);
    tt_10580376 = tt_10580376.kids[chckIndx(0, 0, (tt_10580376.kids).length-1)];
    var types_10580393 = [[]];
    var procs_10580410 = [[]];
    extractItems_10510075(tt_10580376, "Types", types_10580393, 0);
    extractItems_10510075(tt_10580376, "Procs", procs_10580410, 0);
    extractItems_10510075(tt_10580376, "Converters", procs_10580410, 0);
    extractItems_10510075(tt_10580376, "Methods", procs_10580410, 0);
    extractItems_10510075(tt_10580376, "Templates", procs_10580410, 0);
    extractItems_10510075(tt_10580376, "Macros", procs_10580410, 0);
    extractItems_10510075(tt_10580376, "Iterators", procs_10580410, 0);
    var ntoc_10580418 = buildToc_10570082(tt_10580376, types_10580393[0], procs_10580410[0]);
    var x_10580419 = toHtml_10515072(ntoc_10580418, true);
    alternative_10580322[0] = tree_10501020(makeNimstrLit("DIV"), [x_10580419]);
    }
    
    if ((value_10580354 == "type")) {
    replaceById_10501189("tocRoot", alternative_10580322[0]);
    }
    else {
    replaceById_10501189("tocRoot", tree_10501020(makeNimstrLit("DIV"), []));
    }
    
    togglevis_10580336(document.getElementById("toc-list"));

  
}
var db_10580518 = [[]];
var contents_10580520 = [[]];
var oldtoc_10590439 = [null];
var timer_10590440 = [null];
...
function nsuToLowerAsciiChar(c_9415023) {
  var result_9415024 = 0;

    if ((ConstSet2[c_9415023] != undefined)) {
    result_9415024 = chckRange(addInt(c_9415023, 32), 0, 255);
    }
    else {
      result_9415024 = c_9415023;
    }
    

  return result_9415024;

}
function fuzzyMatch_10421054(pattern_10421056, str_10421057) {
              var Tmp4;
              var Tmp5;
                var Tmp6;
      var Tmp7;
  ...
  var result_10421061 = {Field0: 0, Field1: false};

    var scoreState_10421062 = -100;
    var headerMatched_10421063 = false;
    var unmatchedLeadingCharCount_10421065 = 0;
    var consecutiveMatchCount_10421067 = 0;
    var strIndex_10421069 = 0;
    var patIndex_10421071 = 0;
    var score_10421073 = 0;
    L1: do {
        L2: while (true) {
        if (!((strIndex_10421069 < ((str_10421057) == null ? 0 : (str_10421057).length)) && (patIndex_10421071 < ((pattern_10421056) == null ? 0 : (pattern_10421056).length)))) break L2;
          L3: do {
            var patternChar_10421079 = nsuToLowerAsciiChar(pattern_10421056.charCodeAt(chckIndx(patIndex_10421071, 0, (pattern_10421056).length-1)));
            var strChar_10421080 = nsuToLowerAsciiChar(str_10421057.charCodeAt(chckIndx(strIndex_10421069, 0, (str_10421057).length-1)));
            if ((ConstSet3[patternChar_10421079] != undefined)) {
            patIndex_10421071 = addInt(patIndex_10421071, 1);
            break L3;
            }
            
            if ((ConstSet4[strChar_10421080] != undefined)) {
            strIndex_10421069 = addInt(strIndex_10421069, 1);
            break L3;
            }
            
            if ((!(headerMatched_10421063) && (strChar_10421080 == 58))) {
            headerMatched_10421063 = true;
            scoreState_10421062 = -100;
            score_10421073 = ((Math.floor((5.0000000000000000e-01 * score_10421073)))|0);
            patIndex_10421071 = 0;
            strIndex_10421069 = addInt(strIndex_10421069, 1);
            break L3;
            }
            
            if ((strChar_10421080 == patternChar_10421079)) {
            switch (scoreState_10421062) {
            case -100:
            case 20:
              scoreState_10421062 = 10;
              break;
            case 0:
              scoreState_10421062 = 5;
              score_10421073 = addInt(score_10421073, scoreState_10421062);
              break;
            case 10:
            case 5:
              consecutiveMatchCount_10421067 = addInt(consecutiveMatchCount_10421067, 1);
              scoreState_10421062 = 5;
              score_10421073 = addInt(score_10421073, mulInt(5, consecutiveMatchCount_10421067));
              if ((scoreState_10421062 == 10)) {
              score_10421073 = addInt(score_10421073, 10);
              }
              
              var onBoundary_10435042 = (patIndex_10421071 == ((pattern_10421056) == null ? -1 : (pattern_10421056).length - 1));
              if ((!(onBoundary_10435042) && (strIndex_10421069 < ((str_10421057) == null ? -1 : (str_10421057).length - 1)))) {
              var nextPatternChar_10435043 = nsuToLowerAsciiChar(pattern_10421056.charCodeAt(chckIndx(addInt(patIndex_10421071, 1), 0, (pattern_10421056).length-1)));
              var nextStrChar_10435044 = nsuToLowerAsciiChar(str_10421057.charCodeAt(chckIndx(addInt(strIndex_10421069, 1), 0, (str_10421057).length-1)));
              if (!!((ConstSet5[nextStrChar_10435044] != undefined))) Tmp4 = false; else {                Tmp4 = !((nextStrChar_10435044 == nextPatternChar_10435043));              }              onBoundary_10435042 = Tmp4;
              }
              
              if (onBoundary_10435042) {
              scoreState_10421062 = 20;
              score_10421073 = addInt(score_10421073, scoreState_10421062);
              }
            ...
            case -1:
            case -3:
              if (!((ConstSet6[str_10421057.charCodeAt(chckIndx(subInt(strIndex_10421069, 1), 0, (str_10421057).length-1))] != undefined))) Tmp5 = true; else {                if (!(ConstSet7[str_10421057.charCodeAt(chckIndx(subInt(strIndex_10421069, 1), 0, (str_10421057).length-1))] != undefined)) Tmp6 = false; else {                  Tmp6 = (ConstSet8[str_10421057.charCodeAt(chckIndx(strIndex_10421069, 0, (str_10421057).length-1))] != undefined);                }                Tmp5 = Tmp6;              }              var isLeadingChar_10465008 = Tmp5;
              if (isLeadingChar_10465008) {
              scoreState_10421062 = 10;
              }
              else {
                scoreState_10421062 = 0;
                score_10421073 = addInt(score_10421073, scoreState_10421062);
              }
            ...
            patIndex_10421071 = addInt(patIndex_10421071, 1);
              ...
              switch (scoreState_10421062) {
              case -100:
                scoreState_10421062 = -3;
                score_10421073 = addInt(score_10421073, scoreState_10421062);
                break;
              case 5:
                scoreState_10421062 = -1;
                score_10421073 = addInt(score_10421073, scoreState_10421062);
                consecutiveMatchCount_10421067 = 0;
                break;
              case -3:
                if ((unmatchedLeadingCharCount_10421065 < 3)) {
                scoreState_10421062 = -3;
                score_10421073 = addInt(score_10421073, scoreState_10421062);
                }
                
                unmatchedLeadingCharCount_10421065 = addInt(unmatchedLeadingCharCount_10421065, 1);
                break;
              default: 
                scoreState_10421062 = -1;
                score_10421073 = addInt(score_10421073, scoreState_10421062);
      ...
      if (!(patIndex_10421071 == ((pattern_10421056) == null ? 0 : (pattern_10421056).length))) Tmp7 = false; else {        if ((strIndex_10421069 == ((str_10421057) == null ? 0 : (str_10421057).length))) Tmp8 = true; else {          Tmp8 = !((ConstSet9[str_10421057.charCodeAt(chckIndx(strIndex_10421069, 0, (str_10421057).length-1))] != undefined));        }        Tmp7 = Tmp8;      }    if (Tmp7) {
    score_10421073 = addInt(score_10421073, 10);
    }
    
    var colontmp__10600075 = nimMax(0, score_10421073);
    var colontmp__10600076 = (0 < score_10421073);
    nimCopy(result_10421061, {Field0: colontmp__10600075, Field1: colontmp__10600076}, NTI10421058);

  return result_10421061;

}
function escapeCString_10580537(x_10580540, x_10580540_Idx) {
    var s_10580541 = [];
    L1: do {
      var c_10580542 = 0;
      var i_10600080 = 0;
      var L_10600081 = ((x_10580540[x_10580540_Idx]) == null ? 0 : (x_10580540[x_10580540_Idx]).length);
      L2: do {
          L3: while (true) {
          if (!(i_10600080 < L_10600081)) break L3;
            c_10580542 = x_10580540[x_10580540_Idx].charCodeAt(chckIndx(i_10600080, 0, (x_10580540[x_10580540_Idx]).length-1));
            switch (c_10580542) {
            case 60:
              s_10580541.push.apply(s_10580541, makeNimstrLit("&lt;"));;
              break;
            case 62:
              s_10580541.push.apply(s_10580541, makeNimstrLit("&gt;"));;
              break;
            default: 
              addChar(s_10580541, c_10580542);;
              break;
            }
            i_10600080 = addInt(i_10600080, 1);
          }
      } while(false);
    } while(false);
    x_10580540[x_10580540_Idx] = toJSStr(s_10580541);

  
}
function text_10501152(s_10501154) {
  var result_10501155 = null;

    result_10501155 = document.createTextNode(toJSStr(s_10501154));

  return result_10501155;

}
function dosearch_10580556(value_10580558) {
    function HEX3Aanonymous_10590276(a_10590285, b_10590286) {
      var result_10590292 = 0;

        result_10590292 = subInt(b_10590286["Field1"], a_10590285["Field1"]);

      return result_10590292;

    }

  var result_10580559 = null;

    if (((db_10580518[0]).length == 0)) {
    var stuff_10580565 = null;
    ...
    stuff_10580565 = doc.documentElement;
    
    db_10580518[0] = nimCopy(null, stuff_10580565.getElementsByClassName("reference"), NTI1880505);
    contents_10580520[0] = nimCopy(null, [], NTI10580580);
    L1: do {
      var ahref_10590214 = null;
      var ahref_10590214_Idx = 0;
      var i_10600055 = 0;
      var L_10600056 = (db_10580518[0]).length;
      L2: do {
          L3: while (true) {
          if (!(i_10600055 < L_10600056)) break L3;
            ahref_10590214 = db_10580518[0]; ahref_10590214_Idx = chckIndx(i_10600055, 0, (db_10580518[0]).length-1);
            contents_10580520[0].push(ahref_10590214[ahref_10590214_Idx].getAttribute("data-doc-search-tag"));;
            i_10600055 = addInt(i_10600055, 1);
            if (!(((db_10580518[0]).length == L_10600056))) {
            failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    var ul_10590226 = tree_10501020(makeNimstrLit("UL"), []);
    result_10580559 = tree_10501020(makeNimstrLit("DIV"), []);
    setClass_10501135(result_10580559, makeNimstrLit("search_results"));
    var matches_10590247 = [];
    L4: do {
      var i_10590260 = 0;
      var colontmp__10600062 = 0;
      colontmp__10600062 = (db_10580518[0]).length;
      var i_10600063 = 0;
      L5: do {
          L6: while (true) {
          if (!(i_10600063 < colontmp__10600062)) break L6;
            i_10590260 = i_10600063;
            L7: do {
              var c_10590261 = contents_10580520[0][chckIndx(i_10590260, 0, (contents_10580520[0]).length-1)];
              if (((c_10590261 == "Examples") || (c_10590261 == "PEG construction"))) {
              break L7;
              }
              
              var colontmp__10600070 = fuzzyMatch_10421054(value_10580558, c_10590261);
              var score_10590262 = colontmp__10600070["Field0"];
              var matched_10590263 = colontmp__10600070["Field1"];
              if (matched_10590263) {
              matches_10590247.push({Field0: db_10580518[0][chckIndx(i_10590260, 0, (db_10580518[0]).length-1)], Field1: score_10590262});;
              }
              
            } while(false);
            i_10600063 = addInt(i_10600063, 1);
          }
      } while(false);
    } while(false);
    matches_10590247.sort(HEX3Aanonymous_10590276);
    L8: do {
      var i_10590331 = 0;
      var colontmp__10600067 = 0;
      colontmp__10600067 = nimMin((matches_10590247).length, 29);
      var i_10600068 = 0;
      L9: do {
          L10: while (true) {
          if (!(i_10600068 < colontmp__10600067)) break L10;
            i_10590331 = i_10600068;
            matches_10590247[chckIndx(i_10590331, 0, (matches_10590247).length-1)]["Field0"].innerHTML = matches_10590247[chckIndx(i_10590331, 0, (matches_10590247).length-1)]["Field0"].getAttribute("data-doc-search-tag");
            escapeCString_10580537(matches_10590247[chckIndx(i_10590331, 0, (matches_10590247).length-1)]["Field0"], "innerHTML");
            add_10501117(ul_10590226, tree_10501020(makeNimstrLit("LI"), [matches_10590247[chckIndx(i_10590331, 0, (matches_10590247).length-1)]["Field0"]]));
            i_10600068 = addInt(i_10600068, 1);
          }
      } while(false);
    } while(false);
    if ((ul_10590226.childNodes.length == 0)) {
    add_10501117(result_10580559, tree_10501020(makeNimstrLit("B"), [text_10501152(makeNimstrLit("no search results"))]));
    }
    else {
      add_10501117(result_10580559, tree_10501020(makeNimstrLit("B"), [text_10501152(makeNimstrLit("search results"))]));
      add_10501117(result_10580559, ul_10590226);
    }
    

  return result_10580559;

}
function search() {
    function wrapper_10590471() {
        var elem_10590473 = document.getElementById("searchInput");
        var value_10590474 = elem_10590473.value;
        if (!((((value_10590474) == null ? 0 : (value_10590474).length) == 0))) {
        if ((oldtoc_10590439[0] == null)) {
        oldtoc_10590439[0] = document.getElementById("tocRoot");
        }
        
        var results_10595006 = dosearch_10580556(value_10590474);
        replaceById_10501189("tocRoot", results_10595006);
        }
        else {
        if (!((oldtoc_10590439[0] == null))) {
        replaceById_10501189("tocRoot", oldtoc_10590439[0]);
        }
        }
    ...
    if (!((timer_10590440[0] == null))) {
    clearTimeout(timer_10590440[0]);
    }
    
    timer_10590440[0] = setTimeout(wrapper_10590471, 400);
