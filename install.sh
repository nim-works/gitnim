...
if [ $# -eq 1 ] ; then
  ...
  mkdir -p "$nimbleDir/compiler/nir"
  ...
  cp "compiler/nir/cir.nim" "$nimbleDir/compiler/nir/cir.nim"
  chmod 644 "$nimbleDir/compiler/nir/cir.nim"
  cp "compiler/nir/stringcases.nim" "$nimbleDir/compiler/nir/stringcases.nim"
  chmod 644 "$nimbleDir/compiler/nir/stringcases.nim"
  cp "compiler/nir/nirinsts.nim" "$nimbleDir/compiler/nir/nirinsts.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirinsts.nim"
  cp "compiler/nir/nirlineinfos.nim" "$nimbleDir/compiler/nir/nirlineinfos.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirlineinfos.nim"
  cp "compiler/nir/ast2ir.nim" "$nimbleDir/compiler/nir/ast2ir.nim"
  chmod 644 "$nimbleDir/compiler/nir/ast2ir.nim"
  cp "compiler/nir/nirvm.nim" "$nimbleDir/compiler/nir/nirvm.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirvm.nim"
  cp "compiler/nir/types2ir.nim" "$nimbleDir/compiler/nir/types2ir.nim"
  chmod 644 "$nimbleDir/compiler/nir/types2ir.nim"
  cp "compiler/nir/nirc.nim" "$nimbleDir/compiler/nir/nirc.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirc.nim"
  cp "compiler/nir/nir.nim" "$nimbleDir/compiler/nir/nir.nim"
  chmod 644 "$nimbleDir/compiler/nir/nir.nim"
  cp "compiler/nir/nirslots.nim" "$nimbleDir/compiler/nir/nirslots.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirslots.nim"
  cp "compiler/nir/nirfiles.nim" "$nimbleDir/compiler/nir/nirfiles.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirfiles.nim"
  cp "compiler/nir/nirtypes.nim" "$nimbleDir/compiler/nir/nirtypes.nim"
  chmod 644 "$nimbleDir/compiler/nir/nirtypes.nim"
